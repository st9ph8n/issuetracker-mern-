	...
	_createClass(IssueFilter, [{
		...
		value: function render() {
			return React.createElement(
				'div',
				null,
				' this is a place holder for filter '
			);
		}
	}]);
...
var IssueTable = function IssueTable(props) {
	...
	return console.log('at create issue' + props.issues), React.createElement(
		'table',
			...
			fetch('/api/issues').then(function (response) {
				if (response.ok) {
					response.json().then(function (data) {
						//.json() reads a response to completion.it also returns a resolved promise 
